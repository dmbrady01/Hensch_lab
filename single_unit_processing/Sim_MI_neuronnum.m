...
switch length(nneurons)
    case 4 % if there are four inputs (for V1 data)
        ...
        xlim([0 length(nneurons)+1])
        
        %%%%%%%%%%%%%%%%%%%%%%% BOOTSTRAP IQR BAR + CI %%%%%%%%%%%%%%%%%%
        subplot(4,4,4), hold on
        title('Bootstrap IQR + CI')
        bar(1:length(nneurons),[median(bootstrpstat{1}(:,1)) median(bootstrpstat{2}(:,1))...
        ...
        bar(1:length(nneurons),[median(bootstrpstat{1}(:,2)) median(bootstrpstat{2}(:,2))...
        ...
        bar(1:length(nneurons),[median(bootstrpstat{1}(:,3))  median(bootstrpstat{2}(:,3)) median(bootstrpstat{3}(:,3))...
            median(bootstrpstat{4}(:,3))])
        errorbar(1:length(nneurons),[median(bootstrpstat{1}(:,3))  median(bootstrpstat{2}(:,3)) median(bootstrpstat{3}(:,3))...
        ...
        bar(1:length(nneurons),[median(bootstrpstat{1}(:,3)) median(bootstrpstat{2}(:,3))...
        ...
        title('Bootstrap Median of Positively Modulated Cells + Errorbars')
        bar(1:length(nneurons),[median(bootstrpstat{1}(:,4))  median(bootstrpstat{2}(:,4)) median(bootstrpstat{3}(:,4))...
            median(bootstrpstat{4}(:,4))])
        errorbar(1:length(nneurons),[median(bootstrpstat{1}(:,4))  median(bootstrpstat{2}(:,4)) median(bootstrpstat{3}(:,4))...
        ...
        title('Bootstrap Median of Positively Modulated Cells + CI')
        bar(1:length(nneurons),[median(bootstrpstat{1}(:,4)) median(bootstrpstat{2}(:,4))...
