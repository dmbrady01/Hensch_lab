...
rectangle('Position',[-200,0,1400,gvis+4],'FaceColor',[1 1 200/255]); %Light Yellow
...
stimulus_start = line([0 0],[0 gvis+4]); %Creates a line indicating when stimulus started
set(stimulus_start,'Color','k','LineStyle','-','LineWidth',1)
stimulus_end = line([window.stim window.stim],[0 gvis+4]); %Creates a line indicating when stimulus ended
